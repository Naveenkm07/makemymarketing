          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all">
                ...
                <h3 className="text-2xl font-bold mb-4 text-white">City-wide Network</h3>
                <p className="text-purple-200 leading-relaxed">
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-indigo-600/20 backdrop-blur-sm border border-white/10 rounded-3xl p-12">
              <div className="grid md:grid-cols-4 gap-8 text-center">
                <div>
                  ...
                  <div className="text-purple-200">Active Screens</div>
                </div>
                <div>
                  <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent mb-2">
                    2M+
                  </div>
                  <div className="text-purple-200">Daily Impressions</div>
                </div>
                <div>
                  <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent mb-2">
                    50+
                ...
                <div>
                  ...
                  <div className="text-purple-200">Real-time Support</div>
                </div>
              </div>
            </div>
          </div>
