      ...
      <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {/* Mock Data */}
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">M.G. Road Billboard</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">M.G. Road, Bengaluru</td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">₹5000/day</td>
            </tr>
             <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Indiranagar Mall Display</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">100ft Road, Indiranagar</td>
              <td className="px-6 py-4 whitespace-nowrap"><span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">Active</span></td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">₹2500/day</td>
            </tr>
          </tbody>
        </table>
      </div>
